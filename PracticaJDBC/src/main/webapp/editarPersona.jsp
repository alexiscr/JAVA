...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row m-5">
                <div class="col">
                    <form action="${pageContext.request.contextPath}/PersonasServlet?accion=editar" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="edad" id="edad" value="${persona.edad}">
                        </div>
                        <div class="form-group">
